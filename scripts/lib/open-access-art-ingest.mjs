...
function baseArtwork({
  ...
  return {
    ...
    year_start: optionalInt(yearStart ?? year),
    year_end: optionalInt(yearEnd ?? yearStart ?? year),
    date_text: optionalText(dateText),
    medium: optionalText(medium),
    classification: optionalText(classification),
    subclassification: optionalText(subClassification),
    visual_classification: optionalText(visualClassification || classification),
    medium_family: optionalText(mediumFamily),
    primary_artist_id: optionalText(primaryArtistId),
