-- User-owned API keys and usage tracking
...
CREATE INDEX IF NOT EXISTS idx_api_usage_events_gallery ON api_usage_events(gallery_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_artwork_usage_gallery ON artwork_usage_events(gallery_id, created_at DESC);
